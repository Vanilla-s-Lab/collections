...
ADD https://github.com/zlib-searcher/index/releases/download/0.8.1/index_all_0.8.1.zip /root/
RUN ls -al /root && mkdir /index && /bin/unzip /root/index_all_0.8.1.zip -d /
